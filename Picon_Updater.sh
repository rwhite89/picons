...
echo $LINE
opkg install https://github.com/rwhite89/picons/blob/master/enigma2-plugin-picons-snp-full.220x132-220x132.light.on.transparent.ipk?raw=true --add-dest hdd:/media/hdd/SkyQ --add-dest hdd:/media/hdd/SkyQ -d hdd --force-depends >/dev/null 2>&1
