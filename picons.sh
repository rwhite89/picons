#!/bin/sh
echo '############################'
echo '# RICHARD'S PICON UPDATER#'
echo '############################'
echo $LINE
echo 'OUR LATEST PICONS JUST GOT BETTER'
echo 'RICHARDS PICONS'
echo $LINE
sleep 4
...
echo $LINE
opkg install https://github.com/rwhite89/picons/blob/master/SNP_Picons/enigma2-plugin-picons-snp-full.100x60-86x46.light.on.transparent.ipk?raw=true --add-dest hdd:/ -d hdd --force-depends >/dev/null 2>&1
echo $LINE
echo $LINE
...
echo $LINE
opkg install https://github.com/rwhite89/picons/blob/master/SNP_Picons/enigma2-plugin-picons-snp-full.220x132-220x132.light.on.transparent.ipk?raw=true --add-dest hdd:/media/hdd/SkyQ -d hdd --force-depends >/dev/null 2>&1
